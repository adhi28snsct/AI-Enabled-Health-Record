...
export default function AppointmentDetailPanel({
  ...
  const displayStatus =
    (source.status || source.meta?.status || "pending").toLowerCase();
    ...
    >
      ...
      <div className="flex-1 overflow-y-auto p-6 space-y-4">
        ...
        <div>
          ...
          <span
            className={`inline-flex mt-1 px-2 py-0.5 rounded text-sm font-medium ${
        ...
        {!appointment && notification && (
          <div className="pt-3 border-t text-xs text-gray-500">
            Showing data from notification (no API lookup)
          </div>
        )}
      </div>
    </aside>
...
AppointmentDetailPanel.propTypes = {
  ...
  onClose: PropTypes.func, // optional is correct
};